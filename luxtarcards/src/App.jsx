    ...
    >
      ...
      <div className="relative z-10 w-full flex flex-col items-center">
        ...
        <section className="flex flex-col items-center text-center  space-y-1">
          <h1 className="text-3xl font-syne font-bold">Samuel Aburto</h1>
          <p className="text-md font-syne text-red-400">Producción</p>
        </section>
        ...
        <section className="bg-black rounded-2xl shadow-lg mt-6 p-5 w-full max-w-xs space-y-4">
          <div className="flex items-center justify-center gap-4">
            ...
            <p className="text-base font-monse">+52 984 176 0967</p>
          </div>
        </section>
        ...
        <section className="bg-black rounded-2xl shadow-lg mt-4 p-5 w-full max-w-xs">
          <div className="flex justify-around">
            <a href="https://wa.me/529841760967" target="_blank" rel="noopener noreferrer">
              <img src={whatsappIcon} className="w-6 h-6" />
            </a>
            <a href="https://www.instagram.com/samaburtomx?igsh=MXZvZWhsYWxzZnJlOA==" target="_blank" rel="noopener noreferrer">
              <img src={instagramIcon} className="w-6 h-6" />
            </a>
            <a href="https://www.facebook.com/share/15HtCwKgNk/?mibextid=wwXIfr" target="_blank" rel="noopener noreferrer">
